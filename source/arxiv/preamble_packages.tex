...
\usepackage{relsize}
\usepackage{ifthen}
% \usepackage[colorinFlistoftodos]{todonotes}
...
\newtcolorbox{casestudy}[1]{
  colback=blue!2,     % almost white with a hint of blue
  colframe=blue!40,   % desaturated blue-gray border
  arc=2mm,
  boxrule=0.6pt,
  left=6pt,right=6pt,top=6pt,bottom=6pt,
  title=\textbf{#1}
...
% for double-column equations
\usepackage{adjustbox}
\newcommand{\simpleadjustbox}[1]{\adjustbox{max width=\linewidth}{\ensuremath{#1}}}
