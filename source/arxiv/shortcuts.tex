...
\newcommand{\symfun}{\bm{\mathrm{sym}}}
\newcommand{\calAadj}{\calA^{*}}
\newcommand{\bary}{\bar{y}}
\newcommand{\barC}{\bar{C}}
\let\oldoverline\overline
\newcommand{\widebar}[1]{\mkern 1.5mu\oldoverline{\mkern-1.5mu#1\mkern-1.5mu}\mkern 1.5mu}
\let\overline\widebar
